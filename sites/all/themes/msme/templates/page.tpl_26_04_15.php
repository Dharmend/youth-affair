...
<!-- <h3></h3> -->
  <ul> <!---1st li----->
    ...
    <!---2nd li----->
    <li class='has-sub'><a href='#'><span><?php echo t('RMEGY'); ?></span></a>
    <ul>
     <?php 
    global $base_url;
    $tax_result = taxonomy_get_tree(11,2303,NULL,TRUE);
    ...
    <?php } }?>
        ...
        <li class='has-sub'><a href='#'><span><?php echo t('PMEGY'); ?></span></a>
    <ul>
     <?php 
    global $base_url;
    $tax_result = taxonomy_get_tree(11,2303,NULL,TRUE);
    ...
    <?php } }?>
        ...
        <li class='has-sub'><a href='#'><span><?php echo t('EM'); ?></span></a>
    <ul>
     <?php 
    global $base_url;
    $tax_result = taxonomy_get_tree(11,2303,NULL,TRUE);
