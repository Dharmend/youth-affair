...
<!-- Latest News start-->
             ...
             <?php if ($page['latest_news']): ?>
               <span class="lnews-title"><?php print render($page['latest_news']);?></span>
	     <?php endif; ?> 
...
<div class="main-content">
  <div class="about-msme">
    <img src="<?php echo $theme_path;?>/image/about-me.jpg" />
    <p><?php
    ...
    ?></p>
    <a class="more-button" href="<?php echo $base_url.'/'.$current_lng.'/'.$about_path;?>">more</a>
  </div>
  <div class="new-msme">
