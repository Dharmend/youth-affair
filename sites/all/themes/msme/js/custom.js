...
jQuery(document).ready(function(){
	jQuery("#main-menu div" ).children().attr("id","nav");
	...
	jQuery("#sidebar-first .menu-block-wrapper" ).children().attr("id","side_nav");
		//alert('okk');
	dropdown1('side_nav','hover',10);
	jQuery("#sidebar-second .menu-block-wrapper" ).children().attr("id","side_nav");
		//alert('okk');
	dropdown1('side_nav','hover',10);
});
